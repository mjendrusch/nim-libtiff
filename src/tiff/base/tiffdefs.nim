const libTiff = "libtiff.so"

const
  TIFF_VERSION_CLASSIC* = 42
  TIFF_VERSION_BIG* = 43
  TIFF_BIGENDIAN* = 0x00004D4D
  TIFF_LITTLEENDIAN* = 0x00004949
  MDI_LITTLEENDIAN* = 0x00005045
  MDI_BIGENDIAN* = 0x00004550
  TIFFTAG_SUBFILETYPE* = 254
  FILETYPE_REDUCEDIMAGE* = 0x00000001
  FILETYPE_PAGE* = 0x00000002
  FILETYPE_MASK* = 0x00000004
  ...
  GROUP3OPT_2DENCODING* = 0x00000001
  GROUP3OPT_UNCOMPRESSED* = 0x00000002
  GROUP3OPT_FILLBITS* = 0x00000004
  TIFFTAG_GROUP4OPTIONS* = 293
  TIFFTAG_T6OPTIONS* = 293
  GROUP4OPT_UNCOMPRESSED* = 0x00000002
  ...
  CODINGMETHODS_T4_1D* = (1 shl 1)
  CODINGMETHODS_T4_2D* = (1 shl 2)
  CODINGMETHODS_T6* = (1 shl 3)
  CODINGMETHODS_T85* = (1 shl 4)
  CODINGMETHODS_T42* = (1 shl 5)
  CODINGMETHODS_T43* = (1 shl 6)
  ...
  FAXMODE_CLASSIC* = 0x00000000
  FAXMODE_NORTC* = 0x00000001
  FAXMODE_NOEOL* = 0x00000002
  FAXMODE_BYTEALIGN* = 0x00000004
  FAXMODE_WORDALIGN* = 0x00000008
  FAXMODE_CLASSF* = Faxmode_Nortc
  TIFFTAG_JPEGQUALITY* = 65537
  TIFFTAG_JPEGCOLORMODE* = 65538
  JPEGCOLORMODE_RAW* = 0x00000000
  JPEGCOLORMODE_RGB* = 0x00000001
  TIFFTAG_JPEGTABLESMODE* = 65539
  JPEGTABLESMODE_QUANT* = 0x00000001
  JPEGTABLESMODE_HUFF* = 0x00000002
  ...
  DCSINTERPMODE_NORMAL* = 0x00000000
  DCSINTERPMODE_PREVIEW* = 0x00000001
...
type
  uint16Vap* = cint
  TIFFHeaderCommon* = object
    tiffMagic*: uint16
    tiffVersion*: uint16
  TIFFHeaderClassic* = object
    tiffMagic*: uint16
    tiffVersion*: uint16
    tiffDiroff*: uint32
  TIFFHeaderBig* = object
    tiffMagic*: uint16
    tiffVersion*: uint16
    tiffOffsetsize*: uint16
    tiffUnused*: uint16
    tiffDiroff*: uint64
  TIFFDataType* {.size: sizeof(cint).} = enum
    TIFF_NOTYPE = 0, TIFF_BYTE = 1, TIFF_ASCII = 2, TIFF_SHORT = 3, TIFF_LONG = 4,
    TIFF_RATIONAL = 5, TIFF_SBYTE = 6, TIFF_UNDEFINED = 7, TIFF_SSHORT = 8, TIFF_SLONG = 9,
    TIFF_SRATIONAL = 10, TIFF_FLOAT = 11, TIFF_DOUBLE = 12, TIFF_IFD = 13, TIFF_LONG8 = 16,
    TIFF_SLONG8 = 17, TIFF_IFD8 = 18
